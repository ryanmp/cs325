...
This algorithm works by iteratively computing the maximum subarray ending at each position. While iterating, the new max subarray will consist of one more element than the previous.
