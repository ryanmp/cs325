...
This dynamic algorithm only needs to traverse the array of once. The other lines outside of this single loop happen in constant time. So the algorithm only requires O(n). 
