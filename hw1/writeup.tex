...
The slopes of the best fit function lines on the log-log plot were both very close to 2 for the first two algorithms, and about 1.1 for the last. This is what is expected, so no real discrepency to report.
